...
// Scroll animation   ----------------------------------------
	...
	$(document.body).on('appear', '#reflection div.anim', function() {
		$(this).each(function(){
			setTimeout (function (){
				$('#reflection div.anim').animate({opacity:'1', top:'0'},{queue:true,duration:1200});
			}, 600 );
		});
	});
...
// google map styles and functions  --------
	...
	var Chulan = new google.maps.LatLng(42.026619,-93.646465);
	function initialize() {
	   var styles = [
    {
		featureType: 'water',
